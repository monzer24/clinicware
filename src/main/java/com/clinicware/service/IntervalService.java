...
public class IntervalService {
    ...
    public ResponseEntity<Map<String, String>> updateInterval(Interval interval) throws ParseException {
        long start = new SimpleDateFormat("hh:mm").parse(interval.getStart()).getTime();

        long end = new SimpleDateFormat("hh:mm").parse(interval.getEnd()).getTime();
        System.out.println(interval.getDate());
        StoredProcedureQuery query = entity.createStoredProcedureQuery("CREATE_APPT_INTREVALS")
                ...
                .setParameter("P_INTERVAL_DATE", interval.getDate())
